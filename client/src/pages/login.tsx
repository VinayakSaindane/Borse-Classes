...
export default function Login() {
  ...
  return (
    <>
      <Helmet>
        <title>Login - Om Sai Classes</title>
<meta name="description" content="Log in to access your Om Sai Classes student or parent portal." />
        ...
        <div className="md:w-1/2 bg-gradient-to-br from-primary to-primary-dark text-white flex items-center justify-center p-8 md:p-16">
          <div className="max-w-lg">
            <div className="flex items-center space-x-3 mb-8">
              ...
              <h1 className="text-3xl font-bold font-poppins">Om Sai Classes</h1>
            </div>

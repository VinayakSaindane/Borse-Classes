...
<meta name="description" content="Get in touch with Borse Classes. We're here to answer your questions and provide information about our programs." />
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-neutral-900 font-poppins mb-4">Get in Touch</h1>
            <p className="text-lg text-neutral-600">Have questions or need more information? We're here to help.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-neutral-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="h-96 bg-neutral-100 rounded-xl overflow-hidden">
            <iframe 
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-neutral-900 font-poppins mb-4">Have Questions?</h2>

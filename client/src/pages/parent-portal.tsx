...
export default function ParentPortal() {
  ...
  const handleLogin = () => {
    ...
    toast({
      ...
      description: "Welcome to Borse Classes Parent Portal!",
    });
  };
  ...
  if (!isAuthenticated) {
    return (
      <>
        <Helmet>
          <title>Parent Portal - Borse Classes</title>
  ...
  return (
    <>
      <Helmet>
        <title>Parent Dashboard - Borse Classes</title>
        <meta name="description" content="Access your child's academic records, attendance, fee payments, and communicate with teachers." />
        <link href="https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css" rel="stylesheet" />
      </Helmet>
        ...
        <header className="bg-secondary text-white sticky top-0 z-40 shadow-md">
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-white font-medium">Borse Classes Parent Portal</h1>
            </div>

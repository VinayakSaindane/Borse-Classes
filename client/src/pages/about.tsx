...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About Us - Gurav Classes</title>
        <meta name="description" content="Learn about Gurav Classes' history, mission, teaching philosophy, and our team of experienced educators." />
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-neutral-600">Discover the journey, values, and people behind Gurav Classes.</p>
          </div>
        </div>
      </section>

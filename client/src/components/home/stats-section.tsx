      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center">
            <h3 className="text-4xl font-bold text-primary font-poppins">99%</h3>
            <p className="text-neutral-600 mt-2">Success Rate</p>
          </div>
          <div className="text-center">
            <h3 className="text-4xl font-bold text-primary font-poppins">45+</h3>
          ...
          <div className="text-center">
            <h3 className="text-4xl font-bold text-primary font-poppins">8000+</h3>

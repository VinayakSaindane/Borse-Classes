...
export class MemStorage implements IStorage {
  ...
  // Compatibility method to maintain same interface
  async initializeSampleData(): Promise<void> {
    // This is intentionally empty as we initialize data in the constructor
    // This prevents errors in index.ts where this method is called
